...
const navigation: NavigationItem[] = [
  ...
  { name: "Hedeflerimiz", href: "#project", current: false },
            ...
            <div className="flex flex-1 items-center sm:items-stretch sm:justify-start gap-1">
              ...
              <div className="flex flex-shrink-0 items-center">
                <div className="flex gap-1 items-center lg:hidden">
                  <img
                    className="w-16 h-16"
                    src={"/assets/logo/umbrella.gif"}
                    alt="kubbella"
                  />
                  <span className="text-xl font-semibold text-navyblue md:4px lh-96">
                    Kubbella
                  </span>
                </div>
                <div className="hidden lg:flex gap-1 items-center">
                  <img
                    ...
                    alt="kubbella"
                  />
                  <span className="text-2xl font-semibold text-navyblue md:4px lh-96">
                    Kubbella
                  </span>
                </div>
              </div>
